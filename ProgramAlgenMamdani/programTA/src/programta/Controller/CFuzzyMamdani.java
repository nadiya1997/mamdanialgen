...
//      +++++++++++++ Suhu Panas ++++++++++++++++++++++++++++++++++++++++++++++                 
            if(data_cuaca.get(i).getSuhu()<=f_anggota_pakar[1]){
                ...
                f_keanggotaan_cuaca[i][2] = Double.valueOf(format.format((f_anggota_pakar[2]-data_cuaca.get(i).getSuhu())/(f_anggota_pakar[2]-f_anggota_pakar[1])));
            }
            else{
...
//      +++++++++++++ Kelembaban Dry ++++++++++++++++++++++++++++++++++++++++++++++ 
            ...
            else if(data_cuaca.get(i).getKelembaban()>f_anggota_pakar[3] && data_cuaca.get(i).getKelembaban()<f_anggota_pakar[3]){
...
//      +++++++++++++ Kelembaban Moist ++++++++++++++++++++++++++++++++++++++++++++++ 
            if(data_cuaca.get(i).getKelembaban()<=f_anggota_pakar[4]){
                ...
                f_keanggotaan_cuaca[i][5] = Double.valueOf(format.format((f_anggota_pakar[5]-data_cuaca.get(i).getKelembaban())/(f_anggota_pakar[5]-f_anggota_pakar[4])));
            }
            else{
...
//      +++++++++++++ Tekanan Udara Rendah ++++++++++++++++++++++++++++++++++++++++++++++ 
            ...
            else if(data_cuaca.get(i).getTekananUdara()>f_anggota_pakar[6] && data_cuaca.get(i).getTekananUdara()<f_anggota_pakar[6]){
...
//      +++++++++++++ Tekanan Udara Tinggi ++++++++++++++++++++++++++++++++++++++++++++++ 
            if(data_cuaca.get(i).getTekananUdara()<=f_anggota_pakar[7]){
                ...
                f_keanggotaan_cuaca[i][8] = Double.valueOf(format.format((f_anggota_pakar[8]-data_cuaca.get(i).getTekananUdara())/(f_anggota_pakar[8]-f_anggota_pakar[7])));
            }
            else{
...
//      +++++++++++++ Kecapatan Angin Sedang ++++++++++++++++++++++++++++++++++++++++++++++ 
            if(data_cuaca.get(i).getTekananUdara() <= f_anggota_pakar[9]){
                f_keanggotaan_cuaca[i][9] = 1;
            }
            else if(data_cuaca.get(i).getTekananUdara()>f_anggota_pakar[9] && data_cuaca.get(i).getTekananUdara()<f_anggota_pakar[9]){
                f_keanggotaan_cuaca[i][9] = Double.valueOf(format.format((f_anggota_pakar[10]-data_cuaca.get(i).getTekananUdara()/(f_anggota_pakar[10]-f_anggota_pakar[9]))));
            }
            else{
...
//      +++++++++++++ Kecepatan Angin Kencang ++++++++++++++++++++++++++++++++++++++++++++++ 
            if(data_cuaca.get(i).getTekananUdara()> f_anggota_pakar[9] && data_cuaca.get(i).getTekananUdara() < f_anggota_pakar[10]){
                f_keanggotaan_cuaca[i][10] = Double.valueOf(format.format((data_cuaca.get(i).getTekananUdara()-f_anggota_pakar[9])/(f_anggota_pakar[10]-f_anggota_pakar[9])));
            }
            else if(data_cuaca.get(i).getTekananUdara()>f_anggota_pakar[10] && data_cuaca.get(i).getTekananUdara()<f_anggota_pakar[11]){
                f_keanggotaan_cuaca[i][10] = Double.valueOf(format.format((f_anggota_pakar[11]-data_cuaca.get(i).getTekananUdara())/(f_anggota_pakar[11]-f_anggota_pakar[10])));
            }
            else{
...
//      +++++++++++++ Kecepatan Angin Sangat Kencang ++++++++++++++++++++++++++++++++++++++++++++++ 
            if(data_cuaca.get(i).getTekananUdara()<=f_anggota_pakar[10]){
                f_keanggotaan_cuaca[i][11] = 0;
            }
            else if(data_cuaca.get(i).getTekananUdara()>f_anggota_pakar[10] && data_cuaca.get(i).getTekananUdara()<f_anggota_pakar[11]){
                f_keanggotaan_cuaca[i][11] = Double.valueOf(format.format((f_anggota_pakar[11]-data_cuaca.get(i).getTekananUdara())/(f_anggota_pakar[11]-f_anggota_pakar[10])));
            }
            else{
...
//=======================================================================================                            
    ...
    public void do_prediksi(){
        ...
        kondisi_cuaca = new String[f_anggota_output_baru.length];
    ...
    public void hitung_akurasi(){
        ...
        for (int i = 0; i < data_cuaca.size(); i++) {
            ...
            System.out.println(kondisi_cuaca[i].equals(data_cuaca.get(i).getResult()));
        }
